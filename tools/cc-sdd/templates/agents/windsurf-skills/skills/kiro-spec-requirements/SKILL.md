...
1. **Load Context**:
   ...
   - Read `{{KIRO_DIR}}/specs/$1/requirements.md` for project description (if missing but `brief.md` exists — typical getSpecs seed — synthesize project description from brief Problem/Current State/Desired Outcome before generating)
